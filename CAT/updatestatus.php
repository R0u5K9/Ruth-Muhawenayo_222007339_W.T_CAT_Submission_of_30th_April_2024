...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    //GET METHOD: show the data of status of item
   ...
   if (!$row) {
    ...
    //POST METHOD: update the status of item
...
<form method="post">
    ...
    <div class="row mb-3">
        ...
        <a class='btn btn-outline-primary btn-sm' href="status.php" role="button">cancel</a>
      </div>
        </div>
